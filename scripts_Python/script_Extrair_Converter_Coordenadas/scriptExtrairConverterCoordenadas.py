...
nomeDaRotaAtual = "LINHA_2_ABOLICOES_SANTA_DELMIRA_REDENCAO_VOLTA"

#Lendo arquivo de entrada
arquivoEntrada = open("ABOLIÇÕES - SANTA DELMIRA - REDENÇÃO - VOLTA", "r")
...
while coordenadasConvertidas[indice] != None:
	...
	paradas += "\t\t<stopFacility id=\"parada{}{}\" x=\"{}\" y=\"{}\" linkRefId=\"\"/>\n".format(nomeDaRotaAtual, numeroDaParada, coordenadaX, coordenadaY)
	paradasNaRota += "\t\t\t\t<stop refId=\"parada{}{}\" arrivalOffset=\"00:02:00\" departureOffset=\"00:02:00\"/>\n".format(nomeDaRotaAtual, numeroDaParada)
	construcoes += "\t<facility id=\"parada{}{}\" x=\"{}\" y=\"{}\"/>\n".format(nomeDaRotaAtual, numeroDaParada, coordenadaX, coordenadaY)
