...
nomeDaRotaAtual = "nova_mossoroi"

#Lendo arquivo de entrada
arquivoEntrada = open("NOVA MOSSORÓ  - 2 - IDA - IDA", "r")
...
arquivoParadas = open("paradas2.xml", "w")
...
#Criando arquivo paradas
arquivoParadasRota = open("routeProfile2.xml", "w")
#Escrevendo no arquivo paradas
